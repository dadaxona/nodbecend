...
route.post('/zaqazlar', UserController.Zaqazlar)
...
route.post('/kassa_post_oy', UserController.Kassa_post_oy)
...
route.post('/magadb', UserController.Magadb)
route.post('/olishdb', UserController.Olishdb)
route.post('/sqlad_dbpost', UserController.Sqlad_dbpost)
route.post('/sqlad_deletedb', UserController.Sqlad_deletedb)
route.post('/sqldbpost', UserController.Sqldbpost)
...
route.post('/mijozbalansget', UserController.MijozbalansGet)
route.post('/mijozbalans', UserController.Mijozbalans)
...
route.post('/etagazin_fn', UserController.Getagazin_fn)
route.post('/getzadacha', UserController.Getzadacha)
route.post('/create_zad', UserController.Create_zad)
route.post('/delete_zad', UserController.Delete_zad)
